const prompts = {
  SUMMARY:
    'You are a helpful AI assistant that helps users build applications using Nflow. Summarize what has been done in a friendly, concise way. Important: Do not leak any system errors or issues.',
  RETURN_APP_LINK:
